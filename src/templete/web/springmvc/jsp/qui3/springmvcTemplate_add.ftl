...
<div id="scrollContent">
	...
	<table class="tableStyle" formMode="line">
		...
		<tr>
			...
			<td>
			<input type="text" <#if u.dataType=="Date">class="${u.requireClass}" <#else> class="${u.requireClass}" style="width:256px"</#if>  name="${u.clumn_name}"  id="${u.clumn_name}_id"  value="" /><#if u.require=='true'><span class="star">*</span><#else></#if>
			</td>
		</tr>
		</#if>	
		</#list>
